/* ========================================================================
   ...
   All Rights Reserved
   ========================================================================
   Filename: aiwyvern.hxx
   Author:   Lan Zhou
   ======================================================================== */
#if !defined(_AIWYVERN_HXX)
#define _AIWYVERN_HXX
...
inline void WYVERN_DATA::mfInitVals()
{
	Movement.dx = 0;
	Movement.dy = 0;
	Movement.dz = 0;
...
inline void WYVERN_DATA::mfWriteData(FILE *fp) const
{
	fprintf(fp, "%ld %ld\n", Movement.dx, Movement.dy);
}

// read member data from scene file
inline const LONG WYVERN_DATA::mfReadData(FILE *fp)
{
	char cpBuffer[80];
